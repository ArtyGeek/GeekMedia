...
public final class CircleIndicator extends LinearLayout {
    ...
    private int mAnimatorResId = R.animator.transition_indicator;
    private int mAnimatorReverseResId = 0;
    private Drawable mIndicatorBackgroundDrawable;
    private int mIndicatorBackgroundResId = R.drawable.shape_indicator_white;
    private int mIndicatorUnselectedBackgroundResId = R.drawable.shape_indicator_white;
    ...
    private void handleTypedArray(Context context, AttributeSet attrs) {
        ...
        mAnimatorResId = typedArray.getResourceId(R.styleable.CircleIndicator_ci_animator,
                                                  R.animator.transition_indicator);
        ...
        mIndicatorBackgroundResId =
                typedArray.getResourceId(R.styleable.CircleIndicator_ci_drawable,
                                         R.drawable.shape_indicator_white);
    ...
    public void configureIndicator(int indicatorWidth, int indicatorHeight, int indicatorMargin) {
        configureIndicator(indicatorWidth, indicatorHeight, indicatorMargin,
                           R.animator.transition_indicator, 0, R.drawable.shape_indicator_white, R.drawable.shape_indicator_white);
    }
    ...
    private void checkIndicatorConfig(Context context) {
        ...
        mAnimatorResId = (mAnimatorResId == 0) ? R.animator.transition_indicator : mAnimatorResId;
        ...
        mIndicatorBackgroundResId = (mIndicatorBackgroundResId == 0) ? R.drawable.shape_indicator_white
                : mIndicatorBackgroundResId;
        mIndicatorUnselectedBackgroundResId =
        ...
        public void onPageSelected(int position) {
            ...
            if (selectedIndicator != null) {
                if (mIndicatorBackgroundDrawable != null) {
                    selectedIndicator.setBackground(mIndicatorBackgroundDrawable);
                } else {
